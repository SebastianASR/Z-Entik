...
export function LoginPage() {
  ...
  return (
    <AuthShell
      ...
      description="Administra tu sesion con JWT, correo verificado y 2FA cuando tu cuenta lo requiera."
    >
      ...
      <div className="form-links">
        <ActionLink to="/forgot-password">Olvide mi contrasena</ActionLink>
        <ActionLink to="/register">Crear cuenta</ActionLink>
      </div>

      <div className="demo-panel">
        <h3>Usuarios demo</h3>
        <p>No son cuentas reales de produccion. Sirven para revisar la interfaz.</p>
